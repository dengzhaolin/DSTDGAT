...
class Adaptive_Spectral_Block(nn.Module):
    def __init__(self, dim,node_num,dropout=0.1):
        super().__init__()
        self.complex_weight_adaptive = nn.Parameter(torch.randn(node_num, node_num) )
        self.complex_weight = nn.Parameter(torch.randn(node_num, node_num))
        ...
        self.a = nn.Parameter(torch.empty(size=(2 * self.dim, 1)))
