...
import sys
import copy
from serialization import load_adj
sys.path.append("..")
...
if __name__ == "__main__":
    ...
    adj_mx, _ = load_adj(f"{args.dataset}/adj_mx_{args.dataset}.pkl", "doubletransition")
    support = [torch.tensor(i) for i in adj_mx]




    model=DFDGCN(adj.shape[0],supports=support,a=a,affine=affine)
