...
parser.add_argument("--path", type=str, default="PEMS03", help="Dataset path.")
...
df = np.load('../'+args.dataset+'/'+args.path+'/'+args.dataset+".npz")['data']
...
np.save("../data"+'/'+args.path+'/'+"dtw"+".npy",dtw)
