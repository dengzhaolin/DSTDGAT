...
class DGCN(nn.Module):
    def __init__(self, channels=128, num_nodes=170, diffusion_step=1, dropout=0.1, emb=None):
        ...
        self.embed1=nn.Parameter(torch.randn(num_nodes,channels))
    ...
    def forward(self, x):
        ...
        adj_dyn=F.softmax(torch.matmul(self.embed1,self.embed1.T),dim=-1)
...
class STIDGCN(nn.Module):
    def __init__(
        self,  input_dim, num_nodes, channels, granularity, dropout=0.1
    ):
        super().__init__()
