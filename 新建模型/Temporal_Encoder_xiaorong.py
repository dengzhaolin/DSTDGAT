...
class Dilated_Cov(nn.Module):
    def __init__(self,model_dim,head_num,num_nodes,dropout,emb1,emb2,emb3,cheb_polynomials):
        ...
        """
        self.gcn1 = Diffusion_GAT2(model_dim, head_num, num_nodes, dropout=0.1, emb=emb3,
                                   cheb_polynomials=cheb_polynomials)
        self.gcn2 = Diffusion_GAT2(model_dim, head_num, num_nodes, dropout=0.1, emb=emb3,
                                   cheb_polynomials=cheb_polynomials)
        self.gcn3 = Diffusion_GAT2(model_dim, head_num, num_nodes, dropout=0.1, emb=emb3,
                                   cheb_polynomials=cheb_polynomials)
